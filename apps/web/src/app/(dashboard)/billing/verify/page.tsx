      ...
      <div className="bg-white rounded-3xl p-12 text-center shadow-xl max-w-md w-full">
        {status === "loading" && (
          <>
            ...
            <h2 className="text-xl font-extrabold text-gray-900 mb-2" style={{ fontFamily: "var(--font-plus-jakarta-sans)" }}>
              Verifying payment...
            </h2>
        ...
        {status === "error" && (
          <>
            ...
            <button
              ...
              className="text-[#7C3AED] font-semibold text-sm border-none bg-transparent cursor-pointer"
            >
              Back to Billing
            </button>
          </>
